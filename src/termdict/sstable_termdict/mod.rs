...
impl ValueReader for TermInfoValueReader {
    ...
    fn load(&mut self, mut data: &[u8]) -> io::Result<usize> {
        ...
        let mut offsets_start = VInt::deserialize_u64(&mut data)? as usize;
        for _ in 0..num_els {
            ...
            let offsets_num_bytes = VInt::deserialize_u64(&mut data)?;
            ...
            let offsets_end = offsets_start + offsets_num_bytes as usize;
...
impl ValueWriter for TermInfoValueWriter {
    ...
    fn serialize_block(&self, buffer: &mut Vec<u8>) {
        ...
        VInt(self.term_infos[0].offsets_range.start as u64).serialize_into_vec(buffer);
        for term_info in &self.term_infos {
            ...
            VInt(term_info.offsets_range.len() as u64).serialize_into_vec(buffer);
        }
    }
